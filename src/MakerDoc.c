 ...
 * \details	On fournit dans buff une chaine de caractère, une balise spéciale ainsi que le contenu de cette balise
 * \param		buff est une chaine de caractère qui contient une balise spéciale correspondant à une balise html
